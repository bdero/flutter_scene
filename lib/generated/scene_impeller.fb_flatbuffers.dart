...
class Material {
  ...
  int get normalTexture => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 16, -1);
  int get occlusionTexture => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 18, -1);

  @override
  String toString() {
    return 'Material{type: ${type}, baseColorFactor: ${baseColorFactor}, baseColorTexture: ${baseColorTexture}, metallicFactor: ${metallicFactor}, roughnessFactor: ${roughnessFactor}, metallicRoughnessTexture: ${metallicRoughnessTexture}, normalTexture: ${normalTexture}, occlusionTexture: ${occlusionTexture}}';
  }
...
class MaterialT implements fb.Packable {
  ...
  int pack(fb.Builder fbBuilder) {
    ...
    fbBuilder.addInt32(6, normalTexture);
    fbBuilder.addInt32(7, occlusionTexture);
    return fbBuilder.endTable();
  }

  @override
  String toString() {
    return 'MaterialT{type: ${type}, baseColorFactor: ${baseColorFactor}, baseColorTexture: ${baseColorTexture}, metallicFactor: ${metallicFactor}, roughnessFactor: ${roughnessFactor}, metallicRoughnessTexture: ${metallicRoughnessTexture}, normalTexture: ${normalTexture}, occlusionTexture: ${occlusionTexture}}';
  }
}
...
class MaterialObjectBuilder extends fb.ObjectBuilder {
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addInt32(6, _normalTexture);
    fbBuilder.addInt32(7, _occlusionTexture);
    return fbBuilder.endTable();
  }
...
class Vertex {
  ...
  Vec4 get tangent => Vec4.reader.read(_bc, _bcOffset + 24);
  Vec2 get textureCoords => Vec2.reader.read(_bc, _bcOffset + 40);
  Color get color => Color.reader.read(_bc, _bcOffset + 48);

  @override
  String toString() {
    return 'Vertex{position: ${position}, normal: ${normal}, tangent: ${tangent}, textureCoords: ${textureCoords}, color: ${color}}';
  }

  VertexT unpack() => VertexT(
      position: position.unpack(),
      normal: normal.unpack(),
      tangent: tangent.unpack(),
...
class VertexT implements fb.Packable {
  ...
  @override
  String toString() {
    return 'VertexT{position: ${position}, normal: ${normal}, tangent: ${tangent}, textureCoords: ${textureCoords}, color: ${color}}';
  }
}
...
class VertexBuilder {
  ...
  int finish(fb.StructBuilder position, fb.StructBuilder normal, fb.StructBuilder tangent, fb.StructBuilder textureCoords, fb.StructBuilder color) {
    color();
    textureCoords();
    tangent();
    normal();
...
class VertexObjectBuilder extends fb.ObjectBuilder {
  ...
  final Vec4ObjectBuilder _tangent;
  ...
  VertexObjectBuilder({
    ...
    required Vec4ObjectBuilder tangent,
...
class UnskinnedVertexBuffer {
  ...
  @override
  String toString() {
    return 'UnskinnedVertexBuffer{vertices: ${vertices}}';
  }

  UnskinnedVertexBufferT unpack() => UnskinnedVertexBufferT(
      vertices: vertices?.map((e) => e.unpack()).toList());
...
class UnskinnedVertexBufferT implements fb.Packable {
  ...
  int pack(fb.Builder fbBuilder) {
    int? verticesOffset;
    if (vertices != null) {
      for (var e in vertices!) { e.pack(fbBuilder); }
      verticesOffset = fbBuilder.endStructVector(vertices!.length);
    }
  ...
  @override
  String toString() {
    return 'UnskinnedVertexBufferT{vertices: ${vertices}}';
  }
}
...
class SkinnedVertex {
  ...
  Vec4 get joints => Vec4.reader.read(_bc, _bcOffset + 64);
  ///  Four weight values that specify the influence of the corresponding
  ///  joints.
  Vec4 get weights => Vec4.reader.read(_bc, _bcOffset + 80);
...
class SkinnedVertexBuffer {
  ...
  List<SkinnedVertex>? get vertices => const fb.ListReader<SkinnedVertex>(SkinnedVertex.reader).vTableGetNullable(_bc, _bcOffset, 4);

  @override
  String toString() {
    return 'SkinnedVertexBuffer{vertices: ${vertices}}';
  }
...
class SkinnedVertexBufferT implements fb.Packable {
  ...
  @override
  String toString() {
    return 'SkinnedVertexBufferT{vertices: ${vertices}}';
  }
}
...
class SkinnedVertexBufferObjectBuilder extends fb.ObjectBuilder {
  final List<SkinnedVertexObjectBuilder>? _vertices;

  SkinnedVertexBufferObjectBuilder({
    List<SkinnedVertexObjectBuilder>? vertices,
  })
      : _vertices = vertices;
