...
3. Build and run. With `FMOD_SDK_PATH` set, the build hook bundles the libraries into the app; the runtime also falls back to the same environment variables during development.
