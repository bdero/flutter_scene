...
void main() {
  test('applyImpulse changes velocity in the impulse direction', () {
    ...
    expect(body.linearVelocity.y, closeTo(0.0, 1e-9));
    body.applyImpulse(Vector3(0, 5, 0));
    world.step(1.0 / 60.0);
    expect(body.linearVelocity.y, closeTo(5.0, 1e-3));
  });
  ...
  test('applyAngularImpulse spins the body', () {
    ...
    expect(body.angularVelocity.length, closeTo(0.0, 1e-9));
    body.applyAngularImpulse(Vector3(0, 5, 0));
    world.step(1.0 / 60.0);
    expect(body.angularVelocity.y, greaterThan(0.1));
  });
