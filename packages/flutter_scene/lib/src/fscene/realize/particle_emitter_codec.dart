...
class ParticleEmitterCodec extends ComponentCodec {
  ...
  static final List<ComponentPropertyDef> _schema = [
    ComponentPropertyDef(
      ...
      defaultValue: const IntValue(_kMaxParticles),
    ...
    ComponentPropertyDef(
      ...
      defaultValue: const DoubleValue(_kEmitRate),
    ...
    ComponentPropertyDef(
      ...
      defaultValue: const StringValue(_kShapeType),
    ...
    ComponentPropertyDef(
      'shapeRadius',
      ComponentPropertyKind.number,
      defaultValue: const DoubleValue(_kShapeRadius),
    ...
    ComponentPropertyDef(
      'shapeAngle',
      ComponentPropertyKind.number,
      defaultValue: const DoubleValue(_kShapeAngle),
    ...
    ComponentPropertyDef(
      ...
      defaultValue: encodeFloatDistribution(const ConstantFloat(_kLifetime)),
      doc: 'Seconds each particle lives.',
    ),
    ComponentPropertyDef(
      'startSpeed',
      ComponentPropertyKind.distribution,
      defaultValue: encodeFloatDistribution(const ConstantFloat(_kStartSpeed)),
      doc: 'Initial speed along the emission direction.',
    ),
    ComponentPropertyDef(
      'startSize',
      ComponentPropertyKind.distribution,
      defaultValue: encodeFloatDistribution(const ConstantFloat(_kStartSize)),
      doc: 'Initial billboard size in world units.',
    ),
    ComponentPropertyDef(
      'startRotation',
      ComponentPropertyKind.distribution,
      defaultValue: encodeFloatDistribution(const ConstantFloat(0)),
    ...
    ComponentPropertyDef(
      ...
      defaultValue: encodeParticleCurve(ParticleCurve.constant(1.0)),
      doc: 'Size multiplier over normalized age.',
    ),
    ComponentPropertyDef(
      'colorOverLife',
      ComponentPropertyKind.gradient,
      defaultValue: encodeColorGradient(
    ...
    ComponentPropertyDef(
      'drag',
      ComponentPropertyKind.number,
      defaultValue: const DoubleValue(0),
    ...
    ComponentPropertyDef(
      'blendMode',
      ComponentPropertyKind.string,
      defaultValue: const StringValue('alpha'),
    ...
    ComponentPropertyDef(
      'facing',
      ComponentPropertyKind.string,
      defaultValue: const StringValue('spherical'),
    ...
    ComponentPropertyDef(
      ...
      defaultValue: const BoolValue(true),
      doc: 'Whether the emitter emits forever.',
    ),
    ComponentPropertyDef(
      'duration',
      ComponentPropertyKind.number,
      defaultValue: const DoubleValue(5.0),
