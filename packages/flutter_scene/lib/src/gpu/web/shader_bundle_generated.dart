...
// ignore_for_file: unused_import, unused_field, unused_element, unused_local_variable, unnecessary_brace_in_string_interps, unnecessary_non_null_assertion, unnecessary_library_name
//
// MANUAL PATCH: all `fb.Uint64Reader()` were replaced with
// `fb.Uint32Reader()`. The schema declares the reflection scalars
// (location/offset/size/etc.) as uint64, but dart2js/dart2wasm don't
// support ByteData.getUint64. These values all fit in 32 bits and
// flatbuffers are little-endian, so reading the low word is correct.
// Re-apply this substitution if the file is regenerated from the .fbs.
...
class ShaderInput {
  ...
  int get location => const fb.Uint32Reader().vTableGet(_bc, _bcOffset, 6, 0);
  int get $set => const fb.Uint32Reader().vTableGet(_bc, _bcOffset, 8, 0);
  int get binding => const fb.Uint32Reader().vTableGet(_bc, _bcOffset, 10, 0);
  InputDataType get type => InputDataType.fromValue(
    const fb.Uint32Reader().vTableGet(_bc, _bcOffset, 12, 0),
  );
  int get bitWidth => const fb.Uint32Reader().vTableGet(_bc, _bcOffset, 14, 0);
  int get vecSize => const fb.Uint32Reader().vTableGet(_bc, _bcOffset, 16, 0);
  int get columns => const fb.Uint32Reader().vTableGet(_bc, _bcOffset, 18, 0);
  int get offset => const fb.Uint32Reader().vTableGet(_bc, _bcOffset, 20, 0);
...
class ShaderUniformStruct {
  ...
  String? get name =>
      const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 4);
  int get extRes0 => const fb.Uint32Reader().vTableGet(_bc, _bcOffset, 6, 0);
  int get $set => const fb.Uint32Reader().vTableGet(_bc, _bcOffset, 8, 0);
  int get binding => const fb.Uint32Reader().vTableGet(_bc, _bcOffset, 10, 0);
  int get sizeInBytes =>
      const fb.Uint32Reader().vTableGet(_bc, _bcOffset, 12, 0);
