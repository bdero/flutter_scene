...
Status (branch `bdero/renderer`): items 1, 2, 5, 6, 7, 8 are implemented and committed; 3, 4, 9 remain. Everything done so far is compile-verified and smoke-run on macOS + Impeller; visual correctness still wants an on-device pass.
